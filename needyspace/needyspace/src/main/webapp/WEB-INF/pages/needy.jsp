...
<form action="/product/search">
  <div class="container">
    ...
    <input type="text" placeholder="city name" name="cityName" id="cityName"></br>
    <p style="color: blue">*To see all available products, leave above fields empty and click search</p>
